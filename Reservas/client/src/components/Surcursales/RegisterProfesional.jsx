    ...
    <Box>
        ...
        <CardHeader
          ...
          subheader={
            <Typography variant="body2" color="text.secondary">
              Complete la información para crear una nueva cuenta de profesional de la salud
            </Typography>
          }
          sx={{
        ...
        <CardContent sx={{ p: 3 }}>
          <form onSubmit={handleSubmit}>
            ...
            <TextField
              ...
              disabled={loading}
              placeholder="Ej: Medicina General, Cardiología, Psicología..."
              InputProps={{
                startAdornment: (
                  <InputAdornment position="start">
                    <MedicalIcon sx={{ color: '#2596be' }} />
                  </InputAdornment>
                ),
              }}
              sx={{
      ...
      >
        ...
        <Button 
          ...
          variant="contained" 
          disabled={loading}
          startIcon={loading ? null : <MedicalIcon />}
          sx={{
            borderRadius: 2,
            textTransform: 'none',
            fontWeight: 600,
