// Bus de carga global (pub/sub) — usable desde React y desde fuera (interceptores de axios).
...
export const loadingBus = {
  ...
  /** Fuerza el cierre del overlay (p.ej. al desmontar o ante errores globales). */
  reset() {
    count = 0;
    message = 'Cargando…';
    emit();
...
// API imperativa para casos que no pasan por axios.
