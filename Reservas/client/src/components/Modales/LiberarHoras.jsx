...
import { Modal, Box, Typography, TextField, Button, FormControl, FormControlLabel, Radio, RadioGroup } from '@mui/material';
    ...
    <Modal open={open} onClose={onClose}>
        ...
        >
            ...
            <Box backgroundColor="white" borderRadius={'5px'} p={1} mb={0}>
                ...
                <Button variant="contained" color="primary" onClick={handleLiberarHoras} fullWidth>
                    Enviar día
                </Button>
            </Box>
        </Box>
